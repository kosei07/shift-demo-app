...
import Selectbox from "../../../features/staff/components/Selectbox";
...
export default function Worktime(props) {
  ...
  const onOkClick = () => {
    if (start !== "" && finish !== "") {
      ...
      if (
        Number(splitFinish[0] + splitFinish[1]) -
          Number(splitStart[0] + splitStart[1]) <=
          0 ||
        splitStart[0] === "--" ||
        splitFinish[0] === "--"
      ) {
    ...
    return (
      <div className="overlay modal-center">
        <div className="content" onClick={(e) => e.stopPropagation()}>
          <h1>
            {props.month}月{props.date}日
          </h1>
          <p className="margin_padding_0">
            ①②のどちらかを入力し「OK」を押してください
          </p>
          <p className="margin_padding_0">
            また要望などあればコメントに追記してください
          </p>
